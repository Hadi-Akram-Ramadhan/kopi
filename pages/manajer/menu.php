...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    if (isset($_POST['action'])) {
        if ($_POST['action'] == 'add') {
            $stmt = $pdo->prepare("INSERT INTO menu (name, category, price) VALUES (?, ?, ?)");
                                                ...
                                                <form method="POST">
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="mb-3">
                                                            <label class="form-label">Kategori</label>
                                                            <select name="category" class="form-control" required>
                                                                <option value="makanan" <?php echo $item['category'] == 'makanan' ? 'selected' : ''; ?>>
                                                                    Makanan
                                                                </option>
                                                                <option value="minuman" <?php echo $item['category'] == 'minuman' ? 'selected' : ''; ?>>
                                                                    Minuman
                                                                </option>
                                                            </select>
                                                        </div>
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <select name="status" class="form-control" required>
                                                                ...
                                                                <option value="tidak_tersedia" <?php echo $item['status'] == 'tidak_tersedia' ? 'selected' : ''; ?>>
                                                                    Tidak Tersedia
                                                                </option>
                                                            </select>
                                                        </div>
