...
class DataValidations
{
    ...
    public function load(): void
    {
        ...
        foreach ($this->worksheetXml->dataValidations->dataValidation as $dataValidation) {
            ...
            // showDroconnwn is inverted (works as hideDroconnwn if true)
            $docValidation->setShowDroconnwn(!filter_var($dataValidation['showDroconnwn'], FILTER_VALIDATE_BOOLEAN));
